...
err_obj[constants.DEVICE_CREATION_ERROR] = "Unable to create device on IoTHub";
err_obj[constants.DEVICE_DELETION_ERROR] = "Unable to delete device on IoTHub";
err_obj[constants.DEVICE_NOT_FOUND] = "Device is not found ";
err_obj[constants.FLEET_NOT_FOUND] = "Fleet is not found ";
